...
public class GiftCardTest {
    ...
    @Test
    void test07Creates2GiftCardCorrectly() {
    ...
    @Test
    void test08FailsToCreateACardWithInvalidNumber() {
        assertThrows(IllegalArgumentException.class, () ->new GiftCard("martina", -1,1000));
    }
