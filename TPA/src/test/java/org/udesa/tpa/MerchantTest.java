...
public class MerchantTest {
    ...
    @Test
    void test02failsToCreateMerchantWithInvalidId(){
    ...
    @Test
    void test03failsMToCreateMerchantWithInvalidPrivateCredential(){
    ...
    @Test
    void test04createsDifferentMerchantsCorrectly() {
